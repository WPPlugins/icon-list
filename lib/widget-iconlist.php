...
class Kamn_Widget_Iconlist extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			apply_filters( 'icon_list_widget_name', __( 'Icon List', 'kamn-iconlist') ),
			array(
				'classname'   => 'widget-iconlist-kamn',
				'description' => __( 'A widget to display list using icons.', 'kamn-iconlist' )
			)
		);
...
?>
		...
		<p>
			<label><?php _e( 'Title Link (if any):', 'kamn-iconlist' ); ?></label>
        ...
        <p>
			...
			<small><?php printf( __( 'For Font Awesome: <strong>fa-facebook</strong> - <a href="%1$s" target="_blank">Choose Font Awesome Icons</a>', 'kamn-iconlist' ), kamn_iconlist_external_link( 'fa-icons' ) ); ?></small><br />
		</p>
